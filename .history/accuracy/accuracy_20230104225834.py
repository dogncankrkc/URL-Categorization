...
df = df[(df['main_category'] != 'Not_working')&(df['main_category'] != 'Not_working')  & (df['main_category_confidence'] >= 0.5)]
...
target_names = ['Hukuk ve Hükümet', 'Referans',   'Finans', 'Hobi', 'Hayvanlar',
                ...
                'Yetişkin','Alışveriş','Oyunlar','Not working']
